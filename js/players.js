const players = [
  ...
  },
  {
    ...
    photo: "imgs/jarjar.png",
    firstName: "Jar-Jar"
  },
  {
    funFact: "General Grievous is a Dark Side cyborg leading Separatist droid armies.",
    photo: "imgs/grivieous.png",
    firstName: "Grievous"
  },
  {
    funFact: "Shaak Ti is a wise Togruta Jedi Master who oversaw the training of clone troopers on Kamino.",
    photo: "imgs/shaak.png",
    firstName: "Shaak"
  },
  {
  ...
  {
    funFact: "B1 Battle Droids are the clumsy yet iconic foot soldiers of the Separatist Droid Army.",
    photo: "imgs/b1.png",
    firstName: "B1"
  },
  {
    funFact: "Watto is a greedy Toydarian junk dealer who owned Anakin and his mother on Tatooine.",
